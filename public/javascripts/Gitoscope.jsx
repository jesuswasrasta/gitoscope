  ...
  window.Gitoscope.Gitoscope = React.createClass({
    ...
    myLoadAreas() {
      if (document.location.hash !== '') {
        ...
        this.setState({
          currentFileName: '-',
          currentFileWorkingCopy: '',
          currentFileCached: '',
          currentFileCommitted: '',
        });
      }
    },
        ...
        <div>
          <div className="title">
            <div>
              ...
              <a target="_blank" href="/internals">
                go to the graph of the repository
              </a>
            </div>
            <div className="reloader">
              <button type="button" className="btn btn-outline-dark" onClick={this.loadData}>
                reload
              </button>
